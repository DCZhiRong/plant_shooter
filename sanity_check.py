...
classNames = []
classFile = "/home/dan/ros2_ws/src/plant_shooter/Object_Detection_Files/coco.names"
with open(classFile,"rt") as f:
    classNames = f.read().rstrip("\n").split("\n")

#This is to pull the information about what each object should look like
configPath = "/home/dan/ros2_ws/src/plant_shooter/Object_Detection_Files/ssd_mobilenet_v3_large_coco_2020_01_14.pbtxt"
weightsPath = "/home//dan/ros2_ws/src/plant_shooter/Object_Detection_Files/frozen_inference_graph.pb"
...
#Below provides a huge amount of controll. the 0.45 number is the threshold number, the 0.2 number is the nms number)
        result, objectInfo = getObjects(img,0.5,0.2, objects=['cell phone'])
        #print(objectInfo)
